...
####
PROJECT_LIBWEBSOCKETS_WITH_DISABLED_TEST_APPS="${MY_PROJECT_LIBWEBSOCKETS_WITH_DISABLED_TEST_APPS:=OFF}"
PROJECT_LIBWEBSOCKETS_WITH_EXTERNAL_POLL="${MY_PROJECT_LIBWEBSOCKETS_WITH_EXTERNAL_POLL:=OFF}"
PROJECT_OPENSSL_WITH_DEPRECATED_CIPHERS="${MY_PROJECT_OPENSSL_WITH_DEPRECATED_CIPHERS:=OFF}"
PROJECT_OPENSSL_WITH_DISABLED_APPS="${MY_PROJECT_OPENSSL_WITH_DISABLED_APPS:=OFF}"
...
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITH_DISABLED_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITH_DISABLED_TEST_APPS=$PROJECT_LIBWEBSOCKETS_WITH_DISABLED_TEST_APPS")
fi
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITH_EXTERNAL_POLL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITH_EXTERNAL_POLL=$PROJECT_LIBWEBSOCKETS_WITH_EXTERNAL_POLL")
fi
...
if [ "ON" = "$PROJECT_OPENSSL_WITH_DISABLED_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DOPENSSL_WITH_DISABLED_APPS=$PROJECT_OPENSSL_WITH_DISABLED_APPS")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: libwebsockets with disabled test apps: $PROJECT_LIBWEBSOCKETS_WITH_DISABLED_TEST_APPS"
echo "[$SYSTEM_PLATFORM] Component information: libwebsockets with external poll: $PROJECT_LIBWEBSOCKETS_WITH_EXTERNAL_POLL"
echo "[$SYSTEM_PLATFORM] Component information: OpenSSL with deprecated ciphers: $PROJECT_OPENSSL_WITH_DEPRECATED_CIPHERS"
echo "[$SYSTEM_PLATFORM] Component information: OpenSSL with disabled apps: $PROJECT_OPENSSL_WITH_DISABLED_APPS"
