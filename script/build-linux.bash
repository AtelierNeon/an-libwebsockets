...
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITHOUT_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITHOUT_TEST_APPS=$PROJECT_LIBWEBSOCKETS_WITHOUT_TEST_APPS")
fi
